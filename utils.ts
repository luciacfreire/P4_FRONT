...
export async function fetchUsers(): Promise<User[]> {
  ...
  //Devuelve api
  const apiResponse = await handleResponse<{success: boolean; data:User[]}>(response);
...
//Utiliza "DELETE", lo cambiamos a "PUT" para que haga correctamente su función
...
//Utiliza "PUT", lo cambiamos a "DELETE" para que haga correctamente su función
...
//Lo modificamos a "PATCH", como indica en la api
